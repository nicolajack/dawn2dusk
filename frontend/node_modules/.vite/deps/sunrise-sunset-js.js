...
var require_dist = __commonJS({
  "node_modules/sunrise-sunset-js/dist/index.js"(exports) {
    Object.defineProperty(exports, "__esModule", { value: true });
    var DEFAULT_ZENITH = 90.8333;
    var DEGREES_PER_HOUR = 360 / 24;
    var MSEC_IN_HOUR = 60 * 60 * 1e3;
    function getDayOfYear(date) {
      return Math.ceil((date.getTime() - new Date(date.getFullYear(), 0, 1).getTime()) / 864e5);
    }
    function sinDeg(deg) {
...
//# sourceMappingURL=sunrise-sunset-js.js.map
